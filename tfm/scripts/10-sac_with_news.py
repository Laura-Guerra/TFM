...
agent_tune = SACAgent(train_env, val_env, model_dir, log_dir)
...
agent = SACAgent(full_env, test_env, model_dir, log_dir, params=best_params)
agent.train(total_timesteps=500_000)
agent.save("sac_final")

print(f"✅ Model final desat a {model_dir/'sac_final.zip'}")
